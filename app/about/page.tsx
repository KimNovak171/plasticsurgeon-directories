...
export const metadata: Metadata = {
  title: "About This Directory | Dentistry Directories",
  description:
    "Learn about DentistryDirectories.com — a trusted directory helping patients and families compare dental practices and services across the US and Canada.",
  alternates: {
    canonical: "/about",
    languages: {
      "en-us": "https://dentistrydirectories.com/about",
    },
  },
  openGraph: {
    title: "About This Directory | Dentistry Directories",
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-sm text-slate-600">
          DentistryDirectories.com is a professional, easy-to-use directory that helps patients and families find and compare dental practice options across the United States and Canada.
        </p>
      </header>

      <div className="mt-10 max-w-3xl space-y-6 text-sm text-slate-700">
        <p>
          We list verified dental practices and services — so you can explore options by state and city, compare contact details and ratings, and make informed decisions. Our listings are sourced from public information and verified where possible; we encourage you to confirm certifications and quality with your state or provincial authority and to visit practices in person when possible.
        </p>
        <p>
        ...
        <p>
          Dental practice owners can learn about featured and premium listings on our{" "}
